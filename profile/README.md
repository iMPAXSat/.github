...
![IMPAX will measure microburst precipitation both by directly measuring the electrons and by imaging X rays produced by bremsstrahlung in the upper atmosphere due to the precipitation. The direct measurement of the precipitating electrons will provide the spectra of the precipitation and the energy dispersion to determine the source location, while the X-rays provide measurements of the energy deposited by the precipitation and the size of the precipitation region.](colpi1-62_SummaryPaperColpitts-large.gif)
